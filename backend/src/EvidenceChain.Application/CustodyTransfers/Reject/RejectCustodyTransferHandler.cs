...
public sealed class RejectCustodyTransferHandler
{
    private readonly IEvidenceChainDbContext _dbContext;
    private readonly TimeProvider _timeProvider;

    public RejectCustodyTransferHandler(
    ...
    public async Task<CustodyTransferActionResult> HandleAsync(
        RejectCustodyTransferCommand command,
        CancellationToken cancellationToken = default)
    {
        ...
        catch (DbUpdateConcurrencyException)
        {
            ...
            throw new ConcurrencyConflictException(
                "La transferencia fue modificada mientras se procesaba el rechazo.",
