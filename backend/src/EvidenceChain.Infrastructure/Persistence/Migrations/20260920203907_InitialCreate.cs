        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastEventAtUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    IntegrityStatus = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Evidence_LastEventAtUtc",
                table: "Evidence",
                column: "LastEventAtUtc");
